    ...
    const submitData = async () => {
        ...
        if (password === conpassword) {
          ...
          await fetch('http://localhost:5000/register', {
            ...
            document.getElementById("result").innerHTML = "Registration succesfully"
            setState({
                name: "", email: "", mobile: "", address: "", password: "", conPassword: ""
            })
        }
        else {
            document.getElementById("result").innerHTML = "you password and confirm password doesnt match"
        }
        console.log(state)
    }
    return (
